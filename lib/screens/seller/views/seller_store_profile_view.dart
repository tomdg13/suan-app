...
class _SellerStoreProfileViewState extends State<SellerStoreProfileView> {
  ...
  void _fillFromStore() {
    ...
    _descCtrl.text = ''; // description isn't in the Store model'slist view — left blank to edit fresh
  }
    ...
    final croppedBytes = await Navigator.of(context).push<Uint8List>(
      MaterialPageRoute(
        builder: (_) => ImageCropScreen(
          ...
          title: type == 'logo' ? 'ຕັດຮູບໂລໂກ້' : 'ຕັດຮູບພາບປົກ',
        ),
      ),
    );
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      widget.onStoreUpdated(updated);
      setState(() => _successMessage = 'ບັນທຶກແລ້ວ!');
    } on ApiException catch (e) {
      setState(() => _error = e.message);
    } finally {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        const Text('ໂປຣໄຟລ໌ຮ້ານ', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: FilledButton.tonalIcon(
                      ...
                      label: const Text('ພາບປົກ'),
                    ),
                  ),
                  // Logo: last child in the Stack, so it always paints on
                  // top of the cover photo and the "Cover" buttonabove.
                  Positioned(
                    left: 16,
                    bottom: -32,
              ...
              Padding(
                ...
                child: Text(
                  'ແຕະທີ່ພາບປົກ ຫຼື ໂລໂກ້ ເພື່ອປ່ຽນ',
        ...
        const Text('ລາຍລະອຽດຮ້ານຄ້າ', style: TextStyle(fontWeight: FontWeight.bold)),
        const SizedBox(height: 12),
        TextField(
          controller: _nameCtrl,
          decoration: const InputDecoration(labelText: 'ຊື່ຮ້ານຄ້າ', border: OutlineInputBorder()),
        ),
        const SizedBox(height: 12),
        TextField(
          controller: _provinceCtrl,
          decoration: const InputDecoration(labelText: 'ແຂວງ', border: OutlineInputBorder()),
        ),
        const SizedBox(height: 12),
        TextField(
        ...
        TextField(
          ...
          decoration: const InputDecoration(labelText: 'ເບີໂທ', border: OutlineInputBorder()),
        ),
        const SizedBox(height: 12),
        TextField(
