  ...
  void _goToPayment() {
    ...
    final items = _groups
        ...
        .map((i) {
          ...
          return (productId: i.productId, providerId: i.providerId, name: '${i.productName}$variantSuffix', imageUrl: i.imageUrl, price: i.unitPrice, qty: i.qty, weight: i.weight, sizeCm: i.sizeCm);
        })
        .toList();
