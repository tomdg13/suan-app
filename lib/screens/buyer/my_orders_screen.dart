        ...
        MaterialPageRoute(
          builder: (_) => BuyerPaymentScreen(
            ...
            items: order.items.map((i) {
              ...
              return (cartItemId: null, productId: i.productId, providerId: null, name: '${i.itemName}$variantSuffix', imageUrl: i.imageUrl, price: i.unitPrice, qty: i.qty, weight: i.weight, sizeCm: i.sizeCm);
            }).toList(),
